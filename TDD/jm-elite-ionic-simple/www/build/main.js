...
var map = {
	...
	"../pages/lesson-select/lesson-select.module": [
		269,
		2
	],
...
var AuthProvider = (function () {
    function AuthProvider(http, storage, appCtrl) {
        this.http = http;
        this.storage = storage;
        this.appCtrl = appCtrl;
        console.log('Hello AuthProvider Provider');
    }
    AuthProvider.prototype.checkKey = function (key) {
        this.storage.set('eliteLicenseKey', key);
        var body = {
            key: key
        };
        return this.http.post('http://localhost:8080/api/check', body).map(function (res) {
            return res.json();
        });
    };
    AuthProvider.prototype.reauthenticate = function () {
        ...
        return new Promise(function (resolve, reject) {
            _this.storage.get('eliteLicenseKey').then(function (key) {
                if (key !== null) {
                    _this.checkKey(key).subscribe(function (res) {
                        if (res) {
                            resolve(true);
                        }
                        else {
    ...
    AuthProvider.prototype.logout = function () {
        var _this = this;
        this.storage.set('eliteLicenseKey', null).then(function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_auth_auth__ = __webpack_require__(194);
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["d" /* IonicModule */].forRoot(__WEBPACK_IMPORTED_MODULE_8__app_component__["a" /* MyApp */], {}, {
                links: [
                    ...
                    { loadChildren: '../pages/lesson-select/lesson-select.module#LessonSelectPageModule', name: 'LessonSelectPage', segment: 'lesson-select', priority: 'low', defaultHistory: [] },
...
MyApp = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/home/michael/Dev/ionic/jm-elite-ionic-simple/src/app/app.html"*/'<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>\n'/*ion-inline-end:"/home/michael/Dev/ionic/jm-elite-ionic-simple/src/app/app.html"*/
    }),
